...
<section class="welcome-area">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p class="d-none d-md-block"><strong></strong></p>
                    </div>
                </div>
    ...
    <br>
    <br>
    <h1 class="text-center">WELCOME TO EPLAT-ON</h1>
    <div class="text-center">For a best future</div>
    <br>
    <div class="item-group d-flex flex-row justify-content-center">
        <div class="item d-flex justify-content-center align-items-center flex-column">
            <h3>Training</h3>
            <div class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, consequatur?</div>
        </div>
        <div class="item d-flex justify-content-center align-items-center flex-column">
            <h3>Courses</h3>
            <div class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, consequatur?</div>

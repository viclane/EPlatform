...
@section('content')
    ...
    <form action="{{ $editing ? route('admin.plannings.update', ['planning' => $planning->id]) : route('admin.plannings.store') }}" method="post">
        @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($editing)
                                    <a href="{{ route('admin.plannings.index') }}" class="btn btn-secondary">
                                        Annuler
                                    </a>
                                @else
